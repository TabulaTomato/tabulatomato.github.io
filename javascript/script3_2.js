...
function hidePthreeElements() {
  ...
  document.getElementById("removeCard5").style.display = "none";
  document.getElementById("bookPthreeKeep").style.display = "none";
  document.getElementById("bookPthreeReturn").style.display = "none";
  document.getElementById("returnCard1").style.display = "none";
  document.getElementById("returnCard2").style.display = "none";
}
...
function bookPthreeFunction() {
  ...
  if (z == "03") {
      ...
      hidePthreeElements();
  		...
  		answerthree = "The replacement chair Marina ordered for me.";
      hidePthreeElements();
      ...
      removecard1 = "06";
  		...
  		answerthree = "The keycard that opens the doors in the staff quarters.<br><br><i>To use the card, enter the keycard card's number <b>07</b>, followed by the number of the door you want to open in the Digital Game Book input field, separated by a comma. For example, if you want to open door D01, enter '07,D01' in the Digital Game Book input field and press enter.</i>";
      hidePthreeElements();
  } else if (z == "09") {
      ...
      hidePthreeElements();
  		...
  		answerthree = "<i>I sit on the chair and...AAAAA! It breaks! As I fall on the floor and fortunately don't hurt myself a lot, I find a pocket knife hidden under the chair seat cushion. <br>Marina notices what happened and, after asking am I OK, immediately calls somebody to ask for a new chair to be delivered.</i><br>'We may be holding you here against your will, but you should at least have a decent chair. They will deliver it shortly.'<i>, she says.";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("bookPthreeRemove").style.display = "block";
      ...
      answerthree = "Are you up for mixing up my Rubik's cube one more time? Here, try to mix it up as hard as you can, and I'll solve it in a minute. Come on! <br><i>Marina gives me her Rubik's cube to mix it up, as I've done already multiple times.</i>";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      takethree = "<i>Take the following card if you haven't already:</i>";
      ...
      answerthree = "<i>I bring the chair to the vent while Marina isn't looking and climb on it...AAAAA! It breaks! As I fall on the floor and fortunately don't hurt myself a lot, I notice a pocket knife hidden under the chair seat cushion. <br>Marina notices what happened and, after asking am I OK, immediately calls somebody to ask for a new chair to be delivered.</i><br>'We may be holding you here against your will, but you should at least have a decent chair. They will deliver it shortly.'<i>, she says.</i>";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("bookPthreeRemove").style.display = "block";
      ...
      answerthree = "I bring the chair to the air vent and climb on it. ";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("bookPthreeRemove").style.display = "block";
      ...
      answerthree = "I open the box with the pocket knife and find the replacement chair inside.";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("takeCard2").style.display = "inline";
      ...
      answerthree = "This might work!<br><i>I turn my back to the door, so that Marina couldn't see what I'm doing, and I use the pocket knife to push two of the cube parts out of their place. I switch their places afterwards. The cube should be unsolvable now.</i>";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("bookPthreeRemove").style.display = "block";
      ...
      document.getElementById("removeCard1").style.display = "inline";
      document.getElementById("removeCard2").style.display = "inline";
      document.getElementById("bookPthreeKeep").style.display = "block";
      takethree = "<i>Take cards:</i>";
      takecard1 = "07";
      takecard2 = "LOC05";
      ...
      removecard1 = "16";
      removecard2 = "LOC04";
      keepthree = "<i>but keep the other cards from the location <b>LOC04</b> on the table.</i>";
  } else if (z == "11,39" || z == "39,11") {
      answerthree = "If I cut out a few holes in the box, I could orientate myself a bit better.<br><i>I quietly cut out a tiny hole in front of me. I see Marina sitting with her back facing me. She's still completely into solving her Rubik's cube. I cut out a couple more holes in the box.</i>";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("takeCard2").style.display = "inline";
      ...
      answerthree = "There we go! Ready for delivery.";
      hidePthreeElements();
      document.getElementById("bookPthreeTake").style.display = "block";
      document.getElementById("takeCard1").style.display = "inline";
      document.getElementById("bookPthreeRemove").style.display = "block";
      ...
      document.getElementById("removeCard5").style.display = "inline";
      document.getElementById("bookPthreeReturn").style.display = "block";
      document.getElementById("returnCard1").style.display = "inline";
      document.getElementById("returnCard2").style.display = "inline";
      takethree = "<i>Take map parts:</i>";
      takecard1 = "MAP07";
      takecard2 = "MAP08";
      takecard3 = "MAP09";
      mapthree = "<i>Put the map parts on their places above the parts that are already on the table, with <b>MAP07</b> on the left, <b>MAP08</b> in the middle, and <b>MAP09</b> on the right.</i>";
      removethree = "<i>Remove cards:</i>";
      removecard1 = "07";
      removecard2 = "28";
      removecard3 = "SPO05";
      removecard4 = "SPO06";
      removecard5 = "LOC06";
      returnthree = "<i><br>Return the following cards in the character/object deck:</i>";
      returncard1 = "31";
      returncard2 = "33";
      document.getElementById("clickToBridge").style.display = "block";
  } else if (z == "D05" || z == "D07" || z == "D09" || z == "D11" || z == "D17" || z == "D18" || z == "D19" || z == "D20" || z == "D21") {
      answerthree = "I can't pass the door without the keycard.<br><br><i>If you have the keycard use it to open the door. To do that, enter the keycard card's number, followed by the number of the door you want to open in the Digital Game Book input field, separated by a comma. For example, if you want to open door D01, enter '07,D01' in the Digital Game Book input field and press enter.</i>";
      hidePthreeElements();
  	...
  	document.getElementById("removeCard5").innerHTML = removecard5;
  	document.getElementById("bookPthreeKeep").innerHTML = keepthree;
  	document.getElementById("bookPthreeReturn").innerHTML = returnthree;
  	document.getElementById("returnCard1").innerHTML = returncard1;
  	document.getElementById("returnCard2").innerHTML = returncard2;
};
