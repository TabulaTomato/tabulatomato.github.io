...
function bookPthreeFunction() {
  ...
  if (z == "03") {
      ...
      hidePthreeElements();
  		...
  		answerthree = "<i>I sit on the chair and...AAAAA! It breaks! As I fall on the floor and fortunately don't hurt myself a lot, I find a pocket knife that was hidden under the chair seat cushion. <br>Marina notices what happened and, after asking am I OK, immediately calls somebody to ask for a new chair to be delivered.</i><br>'We may be holding you here against your will, but you should at least have a decent chair. They will deliver it shortly.'<i>, she says. <br>Take card <b>11</b>. Remove card <b>14</b>.</i>";
      hidePthreeElements();
  } else if (z == "16") {
  		answerthree = "The vent is closed shut. Two screws are holding the cover.";
      hidePthreeElements();
  } else if (z == "17") {
  		answerthree = "An emtpy box the chair was delivered in. It's quite big considering it was holding only a chair.";
      hidePthreeElements();
  } else if (z == "19") {
      ...
      answerthree = "The box is rather big for holding just a chair. Not a very economical packaging from Monty Furniture in my opinion.";
      hidePthreeElements();
  } else if (z == "33,07") {
      ...
      answerthree = "Thank you my uknown friend, for leaving this unexpected present.";
      hidePthreeElements();
  } else if (z == "33,12") {
      ...
      answerthree = "It looks as if could break any second. What can I do, it's the only chair I've got.'";
      hidePthreeElements();
  } else if (z == "33,17") {
      answerthree = "This box is huge.";
      hidePthreeElements();
  } else if (z == "33,19") {
      answerthree = "A brand new chair. The Lakis are really generous with people that kidnap and planets they occupy.";
      hidePthreeElements();
  } else if (z == "33,24") {
      ...
      answerthree = "It would be great if there was a button for opening the doors on the floor.";
      hidePthreeElements();
  } else if (z == "33,SPO06") {
      ...
      answerthree = "<i>I bring the chair to the vent while Marina isn't looking and climb on it...AAAAA! It breaks! As I fall on the floor and fortunately don't hurt myself a lot, I notice a pocket knife that was hidden under the chair seat cushion. <br>Marina notices what happened and, after asking am I OK, immediately calls somebody to ask for a new chair to be delivered.</i><br>'We may be holding you here against your will, but you should at least have a decent chair. They will deliver it shortly.'<i>, she says. <br>Take card <b>11</b>. Remove card <b>14</b>.</i>";
      hidePthreeElements();
      ...
      answerthree = "I can't skip doors. If I want to to there, I have to open another door first.";
      hidePthreeElements();
  } else if (z == "07,D05" || z == "D05,07") {
      answerthree = "I'm afraid to go there. I remember that the door leads to common area, and there's a great possibility that someone is there now and that they could see me.";
      hidePthreeElements();
      ...
      answerthree = "This seems as a good way to go. Maybe there is another exit on that side of the floor. What? The keycard isn't working on this door! It seems to have another locking system. What are they keeping there? It must be something important if even the lab team doesn't have access to it.";
      hidePthreeElements();
