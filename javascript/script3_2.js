...
function bookPthreeFunction() {
  ...
  if (z == "03") {
      ...
      answerthree = "Do you hear a sound coming from the air vent? Hmmm, I don't hear anything anymore. I guess I imagined it.";
      hidePthreeElements();
      ...
      answerthree = "Thank you my uknown friend, for leaving this passage to the bathroom cabinet for me. Now I have exactly what I need.";
      hidePthreeElements();
  } else if (z == "33,17") {
      ...
      answerthree = "<i>I bring the chair to the air vent and climb on it.<br>Take card <b>16</b>. Remove cards <b>03</b> and <b>19</b>.</i> ";
      hidePthreeElements();
      ...
      answerthree = "This seems as a good way to go. Maybe there is another exit on that side of the floor. What? The keycard isn't working on this door! It seems to have another locking system. What are they keeping there? It must be something important if even the lab team doesn't have the approach there.";
      hidePthreeElements();
      ...
      answerthree = "I don't want to get back in there, I just got out!";
      hidePthreeElements();
