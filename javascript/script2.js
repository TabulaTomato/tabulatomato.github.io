...
function bookPtwoFunction() {
  ...
  if (y == "01") {
      ...
      hidePtwoElements();
  		...
  		answertwo = "My amazing new ability to make me look like anybody in this world. Absolutely crazy.<br><i>To use this ability, enter ability card number <b>26</b> followed by the card number of the person you want to take the appearance of in the Digital Game Book input field, separated by a comma. You can choose any person whose card you have on the table.</i>";
      hidePtwoElements();
  } else if (y == "27") {
      ...
      answertwo = "The printed document from the tablet that mayor Bundy gave me still doesn't make a lot of sense.<br><i>This document will give you the name of the doctor in charge of the restricted ward in the hospital. Once you know the name, write it in the Digital Game Book input field and press enter.</i>";
      hidePtwoElements();
  } else if (y == "SPO06") {
      ...
      answertwo = "My little tree, could you do me a favor and bent a branch just a little bit?.<br><i>As I use my special power, the tree gently lowers one of its branches all the way to the floor.<br>Take card <b>56</b>. Remove card <b>04</b>.</i>";
      hidePtwoElements();
      ...
      answertwo = "I should take the drug to Dr Rose.<br><i>As I arrive at the hospital, I see Dr Rose in the hallway. We move to the side by the coffee machine so that we can speak in private. I pass her the drug that is supposedly capable of removing our powers. She promises she will send it for analysis immediately and that she will try to make an antidote. This will take a while, so I should continue with my investigation in the meantime.<br>Take card <b>LOC06</b>. Remove cards <b>16</b> and <b>57</b>.</i>";
      hidePtwoElements();
  } else if (y == "C29") {
...
function deliveryGuy() {
  ...
  if (deliveryguyinput == "01") {
  	...
  	deliveryguyanswer = "My amazing new ability to make me look like anybody in this world. Absolutely crazy.<br><i>To use this ability, enter ability card number <b>26</b> followed by the card number of the person you want to take the appearance of in the input field, separated by a comma. You can choose any person whose card you have on the table.</i>";
    ...
    deliveryguyanswer = "I should take the drug to Dr Rose.<br><i>As I arrive to the hospital, I see Dr Rose in the hallway. We move to the side by the coffee machine, so that we can speak in private. I pass her the drug that is supposedly capable of removing our powers. She promises she will send it for analysis immediately and that she will try to make an antidote. This will take a while, so I should continue with my investigation in the meantime.<br>Take card <b>LOC06</b>. Remove cards <b>16</b> and <b>57</b>.</i>";
...
function unknownMan() {
  ...
  if (unknownmaninput == "01") {
    ...
    unknownmananswer = "The printed document from the tablet that mayor Bundy gave me still doesn't make a lot of sense.<br><i>This document will give you the name of the doctor in charge of the restricted ward in the hospital. Once you know the name, write it in the Digital Game Book input field and press enter.</i>";
    ...
    unknownmananswer = "I should take the drug to Dr Rose.<br><i>As I arrive to the hospital, I see Dr Rose in the hallway. We move to the side by the coffee machine, so that we can speak in private. I pass her the drug that is supposedly capable of removing our powers. She promises she will send it for analysis immediately and that she will try to make an antidote. This will take a while, so I should continue with my investigation in the meantime.<br>Take card <b>LOC06</b>. Remove cards <b>16</b> and <b>57</b>.</i>";
    ...
    unknownmananswer = "She's been here, asking questions. But don't worry, she doesn't have a clue. And we better keep it that way. Here is a copy of the document for your boss. He already knows the code.<br><i>The mayor says he has work to do and politely asks me to leave. I can feel that he's quite intimidated by my unknown man's presence, but he doesn't want me to notice.<br>Take card <b>10</b>. Remove cards <b>45</b> and <b>LOC07</b>.<br>Return to your Ziggy appearance and use the original Game Book input field.</i>";
  } else if (unknownmaninput == "45,13" || unknownmaninput == "45,45") {
    unknownmananswer = "Your boss sent you here to see me? Well, I'm not going to keep you, I know what you came for. Here is a copy of the document. Your boss already knows the code.<br><i>The mayor says he has work to do and politely asks me to leave. I can feel that he's quite intimidated by my unknown man's presence, but he doesn't want me to notice.<br>Take card <b>10</b>. Remove cards <b>45</b> and <b>LOC07</b>.<br>Return to your Ziggy appearance and use the original Game Book input field.</i>";
  } else if (unknownmaninput == "45,23") {
    unknownmananswer = "You know very well that I don't want to know anything more than I need to. As far as I'm concerned, our business is finished. Here is a copy of the document for your boss. He already knows the code.<br><i>The mayor says he has work to do and politely asks me to leave. I can feel that he's quite intimidated by my unknown man's presence, but he doesn't want me to notice it.<br>Take card <b>10</b>. Remove cards <b>45</b> and <b>LOC07</b>.<br>Return to your Ziggy appearance and use the original Game Book input field.</i>";
	} else {
...
function turner() {
  ...
  if (turnerinput == "01") {
    ...
    turneranswer = "I should take the drug to Dr Rose.<br><i>As I arrive to the hospital, I see Dr Rose in the hallway. We move to the side by the coffee machine, so that we can speak in private. I pass her the drug that is supposedly capable of removing our powers. She promises she will send it for analysis immediately and that she will try to make an antidote. This will take a while, so I should continue with my investigation in the meantime.<br>Take card <b>LOC06</b>. Remove cards <b>16</b> and <b>57</b>.</i>";
