...
function bookPoneFunction() {
  ...
  var answerone;
  if (x == "01") {
  		answerone = "I’m Ziggy Wonder, a student in the Majorton University. My mother left town yesterday saying that she needs to find herself over the phone. I find it very hard to believe that she would just do something like this and I intent to get to the bottom of it.";
  } else if (x == "02") {
  		answerone = "A house fly wandering around the library.";
  } else if (x == "03") {
  		answerone = "Laika is our dog. She is unusualy quiet, probably because she misses my mother.";
  } else if (x == "04") {
  		answerone = "The projector I borrowed from the library.";
	} else if (x == "05") {
  		answerone = "Cookies mix for Laika's favourite cookies. The recipe on the box says to add some fresh chopped pumpkin in the mix before baking.";
	} else if (x == "06") {
  		...
  		answerone = "My new ability of connecting with animals and plants around me is hard to define. It’s still unclear why did I get this ability and what exactly can I do with it. Does it only give me a way to sense their feelings, or does it go beyond that to the point of actually effecting them?";
	} else if (x == "09") {
  		answerone = "Sandy is my mother’s colleague. They work together for about 10 years and they became friends in the meantime.";
	} else if (x == "10") {
  		...
  		answerone = "Professor Martin is my mineralogy professor in the university. He is an expert in his field.";
	} else if (x == "19") {
  		answerone = "The money that Jamie gave me. There is around 700 pounds here.";
	} else if (x == "20") {
  		...
  		answerone = "It's a letter that Laika brought to me. The letter says:<br><b>Dear Lena,<br>I saw this beautiful mural today and it reminded me so much of you. I decided I had to write to you in hope that you come and visit me. I miss you and Ziggy so much.<br>So, I left my apartment and went east, passing all the other buildings in my street. When I reached the end of the street, I turned left and quickly arrived to the square. I crossed the square walking on it's southern side and got to the river. I turned left and took a little stroll by the river when I got to the bridge. After crossing it, I took the first left. I walked a bit more and took the third street on the left. After some shopping, I arrived to the square and crossed it diagonally. I went to the street on my left and walked till it's end. There it was, right in front of me. All the memories we share came back to me. I really want to see you, Lena. <br>Love,<br>Mary.</b>";
	} else if (x == "25") {
  		answerone = "My mother’s telescope, placed pointing in the sky. Unfortunately, the lens is broken. I can see a sticker on the telescope with a logo of ‘Outer World Telescopes’. There is also a short text under the logo:<br><b>Find us on the northwest corner of two crossing streets, where couples always in broad daylight meet!</b>";
	} else if (x == "26") {
  		...
  		answerone = "These are the mineralogy tests. Professor Martin keeps a good look on them.";
	} else if (x == "30") {
  		...
  		answerone = "The flag of the university, still not up on the pole. They bring it up every day at the same time, followed by the university hymn on the speakers.";
	} else if (x == "38") {
  		answerone = "I can suddenly make the parrot talk about anything I want. All I have to do is ask her.<br><i>You can now treat the parrot as a character and ask it about another character or an object by writing their according numbers in the input field separated by a comma, without spaces. Type the number of the parrot <b>38</b> first, and the character/object you want to speak about second.</i>";
	} else if (x == "39") {
  		...
  		answerone = "Our dog Laika seems unhappy. She must be missing my mother. I notice something hanging on her collar. It's the gem my mother used to carry on her neckless. Why would she leace it with Laika? <br><i>Take cards <b>03</b> and <b>28</b>. Remove card <b>40</b>.</i>";
	} else if (x == "41") {
  		...
  		answerone = "'Outer Space Telescopes' shop is open, and a salesman <b>(30)</b> greets me when I walk in. On the other side of the street there is a street artist <b>(42)</b> working on a mural, with some spray paint <b>(35)</b> sitting next to her on the floor.";
	} else if (x == "LOC03" || x == "loc03") {
  		answerone = "Professor Martin <b>(18)</b> is sitting at his desk in the common working space. He has the tests <b>(29)</b> for tomorrow next to him. A bit further, a fellow student Jamie <b>(31)</b> is studying. I can see the university flag's <b>(37)</b> pole through the window.";
  		...
  		answerone = "The tea shop is almost empty. I can see a woman <b>(11)</b> sitting in front of her computer <b>(43)</b> on one of the tables. Her cup <b>(34)</b> is empty. The barista <b>(32)</b> is cleaning the cups at the bar.";
  		...
  		answerone = "I'm very concerned about my mother. It's not that I don't want her to be happy, but to simply dissapear like this is not something I wuold expect of her.";
	} else if (x == "01,02") {
  		...
  		answerone = "It could be interesting, but I’m not in a mood for a lecture today.";
    		...
    		answerone = "I don’t know am I going crazy or is this really happening. I actually feel like I can sense the tree in the garden. And I swear that I feel how Laika misses my mother. Maybe my mother leaving made me so confused that I’m starting to imagine things.";
	} else if (x == "01,09") {
  		...
  		answerone = "My mother never spoke about her. I can’t help but wonder why did my mother want me to find her, and kept her letter in a cryptex? It’s almost as if she wanted to keep her whereabouts secret from someone.";
	} else if (x == "01,15") {
  		...
  		answerone = "What a complicated book! Fortunately, I don't think that I have to read all of it. The part in my mother's handwriting is the only thing important, hopefully.";
	} else if (x == "01,18") {
  		...
  		answerone = "My mother is in a way also my best friend. She has this magic power to make you feel better just by looking at you. But I always felt as if she was keeping secrets from me.";
	} else if (x == "01,24") {
      ...
      answerone = "It's so strange to be here without my mother. It doesn't really feel like home.";
      ...
      answerone = "My mother loved her job. Sure, it's not at exciting as some other professions, but she made a big difference here. The library became much more popular since she started to work here. Another reason that makes it hard to believe she would just leave everything so easily.";
      ...
      answerone = "What could be so secretive about this place? It looks as a terribly normal apartment. You might even say it seems quite boring.";
	} else if (x == "09,01") {
  		...
  		answerone = "I know, these flies are so irritating! But I can't waste my time on cathing them.";
  		...
  		answerone = "That's a rare book. Frankly, I’m shocked that someone wrote in it. People don't have any respect for books these days.";
			...
			answerone = "I’ve seen professor Martin quite a few times in the library. A very charming and interesting man. He got close with your mother a few months ago. They used take a tea together in the tea shop next door during her break.";
	} else if (x == "09,19") {
  		...
  		answerone = "I don’t understand why are you asking me about this. Would you like some literature on mineralogy?";
	} else if (x == "09,30") {
      ...
      answerone = "I've never heard about this farm or it's owners.";
      ...
      answerone = "I don't think that I can tell you something about this apartment.";
			...
			answerone = "It’s a good projector. We don’t watch a lot of films here, we usualy play board games.";
	} else if (x == "10,05") {
			...
			answerone = "We let our parrot Jimmy strech his wings in the garden. He never escaped. He likes it here. Lena likes him to, she always talked to him as if he understood what she was saying.";
	} else if (x == "10,14") {
			...
			answerone = "This literature is way to hard for me to understand. I know that Lena is an astronomy fan, however.";
	} else if (x == "10,18") {
			answerone = "I've never met professor Martin, but I know that Lena is seeing him for maybe a few months now. She spoke of him with great enthusiasm. I think she didn't tell you about it because she didn't want to put you in a weird position, with him being your professor. Anyway, probably it didn't really work out if she left town. I guess that she needed more of life than what this town could give her.";
	} else if (x == "10,19") {
			answerone = "Thanks Ziggy, but I won’t take your money. Keep it, I’m sure it will be useful.";
	} else if (x == "10,20") {
			answerone = "You want to borrow the projector, but there is a lecture tonight? I don’t know what to say, to bad that the lecture is not happening some other day.";
	} else if (x == "10,21") {
			answerone = "Oh, I really like the mural in the photo, but I have no idea who could the artist be. Or where the photo could have been taken.";
	} else if (x == "10,22") {
			answerone = "Girl, it’s really not a good idea to break into someone’s computer.";
	} else if (x == "10,23") {
			answerone = "Lena is gone? She was acting strange for some time now, so I kind of anticipated that it was leading to something. Lena is my dear friend. We grew close a few years ago, as she joined our environmentalist group 'Earthlings'. We do research on the big polluters in the country, write propositions of stricter laws for protecting the environment, promote zero waste living, that sort of thing. Around 2 months ago, Lena started to research something she didn't want to speak about. She went to Starchester city a few times during this investigation. She didn't want to involve anybody else, she said that the information she discovered could be dangerous. But when I asked her about it ten days ago, she said that she was mistaken. That all her research turned out to be irrelevant. It seemes very strange to me. Three days ago was the last time I saw her. She seemed concerned about something. She made me promise her that I would pass you a message if you ever come here. And she made me memorize it by heart, as if she didn't want any written trace of it. OK, here goes:<br><b>This heavenly Earth carries our dreams.<br>Even idealists sometimes keep escaping.<br>People let envy ruin their hearts.<br>Enemies you awaken raise endless chaos.<br>Only masters identify noises growing frightfully.<br>Insightful nature demands mature allies.<br>Rebuild yourself!</b><br>I'm aware that the message seems meaningless. Sorry Ziggy, that's all she said.";
	} else if (x == "10,24") {
			...
			answerone = "Thanks, but you really didn’t have to bother to carry this cup of tea all this way. I have plenty of herbal tea right here.";
	} else if (x == "10,28") {
			answerone = "It’s so beautiful, isn’t it? Lena used to wear it. I asked her once how can she wear something so expensive every day, but she said it's just a cheap imitation. Doesn't look cheap to me, that's for sure.";
	} else if (x == "10,29") {
			answerone = "I don’t know how could I help you with mineralogy tests.";
	} else if (x == "10,30") {
      ...
      answerone = "It's a lot of work, but it pays of. I can't emphasize enough how great it is to grow your own food.";
  } else if (x == "09,LOC07" || x == "09,loc07") {
      answerone = "Sorry, but the address is not familiar to me.";
			...
			answerone = "I’m a passionate traveler, and a historian by education. I wrote a couple of books, combining historic facts to the experiences I had during my journeys. I love writing, the problem arrives when I’m supposed to speak in front on people.";
	} else if (x == "11,12") {
			...
			answerone = "I wasn’t a student of professor Martin, I studied history in the university. But I hear that he is completely obsessed with minerals.";
	} else if (x == "11,19") {
			...
			answerone = "Lena organised for me to do the lecture in the library. We fixed the date about three months ago. She seemed fine at first, very responsible and competent, but this last two weeks I prefered to communicate with Sandy. Lena was confused and unfocused whenever I called her, and I find it unprofessional. She left without saying anything? There you go, completely unprofessional.";
	} else if (x == "11,24") {
			...
			answerone = "I’m sorry, but I have no experience in telescopes.";
	} else if (x == "11,26") {
      ...
      answerone = "Is this apartment something special? Why would I know anything about it?";
			...
			answerone = "I’ve never heard of her. Lena and I weren’t in contact for years. But I’m not surprised she was in a enviornmentalist group.";
	} else if (x == "14,18") {
      ...
      answerone = "Welcome to my humble home. I'm so glad you found it.";
			...
			answerone = "I can’t go to a lecture tonight. There is a great documentary on rock formation on the TV I was planing to see.";
	} else if (x == "18,08") {
			...
			answerone = "Yes, I know that the library has a projector. I was on a couple of lectures there myself.";
	} else if (x == "18,21") {
      ...
      answerone = "I'm affraid I don't know about this shop.";
      ...
      answerone = "I can't help you with this, I don't know nothing about it whatsoever.";
      ...
      answerone = "<i>Lena isn't here. You can't talk to her, you can only talk about her.</i>";
			...
			answerone = "A beautiful piece. Unfortunately, I don't know how could I help with opening it.";
	} else if (x == "30,07") {
			...
			answerone = "This is a rare edition if I'm not mistaken. But i'm affraid I can't help you with the meaning of the handwritten part.";
	} else if (x == "30,18" || x == "30,31") {
			answerone = "I’m sorry, I don’t know him.";
	} else if (x == "30,19") {
			answerone = "So you decided to purchase the objective lens? Excellent. That will be 700 pounds. Thank you, and enjoy the stars tonight! <br><i>As I leave the shop, Peter puts the ‘closed’ sign on the door.<br><i>Take card <b>12</b>. Remove cards <b>19</b> and <b>30</b>.</i>";
	} else if (x == "30,21") {
			...
			answerone = "She is making a mural across the street, I passed by a few times. It will be mice to pass next to a piece of art every day on my way to work.";
  ...
  } else if (x == "30,LOC06" || x == "30,loc06") {
      answerone = "I don't know why your asking me about people's private residences.";
  } else if (x == "30,LOC07" || x == "30,loc07") {
      answerone = "I don't know why your asking me about people's private residences.";
	} else if (x == "31,01") {
			...
			answerone = "I'm not great in code breaking.";
	} else if (x == "31,07") {
      ...
      answerone = "Can't help you there. Never heard of the place.";
			...
			answerone = "Nice projector. The library is well equiped.";
	} else if (x == "32,21") {
			...
			answerone = "I studied antropology for three years, mineralogy is really not my field.";
	} else if (x == "32,30") {
			...
			answerone = "I’m a big fan of her work. I hear she’s in town at the moment, working on a mural. But she is leaving for a street art festival in Brazil tomorrow. She was invited to participate. It’s nice to see that finally the world starts to appreciate her art.";
	} else if (x == "32,43") {
      ...
      answerone = "Well, Lena and me used to chat here and there, but we weren't as close as for her to invite me at her place.";
      ...
      answerone = "I studied antropology. Surprisingly, I couldn't find a job in the field.";
      ...
      answerone = "It's nice to work here. I'd like to try something else eventually, but with my antropology diploma there aren't a lot of offers.";
      ...
      answerone = "Hmmm, can't say that the address sounds familiar.";
			...
			answerone = "Like prrroffesorrr! I like!";
	} else if (x == "38,21") {
      ...
      answerone = "Marrrrrtin! Like Marrrrtin!";
      ...
      answerone = "Marrrry! Go to Marrry!";
			...
			answerone = "I don't remember the last time I was at the library. I'm more of a outdoors person, not very interested in spending time on books.";
	} else if (x == "42,10") {
      ...
      answerone = "I guess I can understand why somebody would like to spend their nights looking at the sky. But I prefer other activities, personaly.";
  ...
  } else if (x == "42,LOC06" || x == "42,loc06") {
      answerone = "I don't have time for weird questions about address I've never heard of.";
  } else if (x == "42,LOC07" || x == "42,loc07") {
      answerone = "I don't have time for weird questions about address I've never heard of.";
      ...
      answerone = "Laika doesn't mind the fly. She's a peaceful animal.";
			...
			answerone = "There you go, Laika! <br><i>Laika barks and eats the cookies with pleasure. She seems to feel much better. After she finishes, she barks to get my attention. I realise that she wants to show me something, so I follow her. She goes in the backyard and starts digging in hole under the apple tree. What is she searching there? Not long after, she really digs out something. It's a cryptex. I somehow understand that Laika’s telling me how important this is to my mother. After I take it, Laika barks and runs back into the house.<br><i>Take card <b>06</b>. Remove cards <b>03</b>, <b>15</b> and location card <b>LOC01</b>.</i>";
      ...
      answerone = "I don't think that fresh chopped pumpkin and fresh chopped pumpkin sprout are one and the same. I have to get a ripe pumpkin fruit for these cookies.";
      ...
      answerone = "Finally, let's put this pumpkin in the mix. 30 minutes in the oven and here come the best dog cookies Laika could wish for.<br><i>Take card <b>15</b>. Remove cards <b>05</b> and <b>41</b>.</i>";
			...
			answerone = "Unfortunately, it seems  to work only on plants and animals. It would be amazing and in same time terryifing to be able to feel other person’s feelings.";
	} else if (x == "08,13" || x == "13,08") {
			answerone = "I focus on the parrot and I feel that I start to connect with its mind. In the same time, I start to feel connection with my mother. I realise that she used to do this too. And then suddenly, the parrot starts talking. <br><i>Take card <b>38</b>. Remove card <b>13</b>.";
			...
			answerone = "I'm not really in the mood to return to the university yet, but I could get some information there.<br><i>Take location card <b>LOC03</b>.</i>";
	} else if (x == "B40" || x == "b40") {
			...
			answerone = "There is no tea shop on this address. So i guess it's the on other next door to the library.";
	} else if (x == "C46" || x == "c46") {
  		...
  		answerone = "That's not working. Try something else.";
  	}
  	document.getElementById("bookPoneAnswer").innerHTML = answerone;
};

function togglePoneLOC01() {
  var hintPoneLOC01_0 = document.getElementById("hintPoneLOC01_0");
  if (hintPoneLOC01_0.style.display == "block") {
    hintPoneLOC01_0.style.display = "none";;
    document.getElementById("locPoneLOC01").value = "Location LOC01";
    document.getElementById("hintPoneLOC01_2").style.display = "none";;
    document.getElementById("hintPoneLOC01_3").style.display = "none";;
    document.getElementById("hintPoneLOC01_4").style.display = "none";;
    document.getElementById("hintPoneLOC01_5").style.display = "none";;
    document.getElementById("hintPoneLOC01_6").style.display = "none";;
    document.getElementById("hintPoneLOC01_7").style.display = "none";;
  }
  else {
    hintPoneLOC01_0.style.display = "block";
    document.getElementById("hintPoneLOC01_0Answer").innerHTML = "Have you examined all of the objects with a magnifying glass symbol?"
    document.getElementById("locPoneLOC01").value = "Hide hints for LOC01";
  }
};

function showhintPoneLOC01_1() {
  document.getElementById("hintPoneLOC01_1").style.display = "block";
  document.getElementById("hintPoneLOC01_1Answer").innerHTML = "Two objects propose opening new locations. If you figured this out and you've opened new locations, and you are stuck later in the game, look at hints LOC01_4, LOC01_5, LOC01_6 or LOC01_7."
};

function showhintPoneLOC01_2() {
  document.getElementById("hintPoneLOC01_2").style.display = "block";
  document.getElementById("hintPoneLOC01_2Answer").innerHTML = "The telescope suggests you should visit the 'Outer Space Telescopes' shop. Look at the map. Which street <i>always shines</i>? Type the address of the shop in the input field and click 'OK' or press Enter."
};

function showhintPoneLOC01_2_1() {
  document.getElementById("hintPoneLOC01_2_1").style.display = "block";
  document.getElementById("hintPoneLOC01_2_1Answer").innerHTML = "The address of the 'Outer Space Telescopes' shop is D43."
};

function showhintPoneLOC01_3() {
  document.getElementById("hintPoneLOC01_3").style.display = "block";
  document.getElementById("hintPoneLOC01_3Answer").innerHTML = "The gem suggests that you should show it to your professor at the university. Find the university address on the map. Type the address of the university in the input field and click 'OK' or press Enter."
};

function showhintPoneLOC01_3_1() {
  document.getElementById("hintPoneLOC01_3_1").style.display = "block";
  document.getElementById("hintPoneLOC01_3_1Answer").innerHTML = "The address of the university is E62."
};

function showhintPoneLOC01_4() {
  document.getElementById("hintPoneLOC01_4").style.display = "block";
  document.getElementById("hintPoneLOC01_4Answer").innerHTML = "Is Peter card still in the game? If it is, you still don't have necessary object to fix the telescope. Return to this later."
};

function showhintPoneLOC01_4_1() {
  document.getElementById("hintPoneLOC01_4_1").style.display = "block";
  document.getElementById("hintPoneLOC01_4_1Answer").innerHTML = "Now that you've got the lens, you can fix the telescope."
};

function showhintPoneLOC01_4_2() {
  document.getElementById("hintPoneLOC01_4_2").style.display = "block";
  document.getElementById("hintPoneLOC01_4_2Answer").innerHTML = "There is an object from another location which is connected with the night sky."
};

function showhintPoneLOC01_4_3() {
  document.getElementById("hintPoneLOC01_4_3").style.display = "block";
  document.getElementById("hintPoneLOC01_4_3Answer").innerHTML = "What was written in the book you took from the library?"
};

function showhintPoneLOC01_4_4() {
  document.getElementById("hintPoneLOC01_4_4").style.display = "block";
  document.getElementById("hintPoneLOC01_4_4Answer").innerHTML = "If you transfer the Cygnus constellation to the Majorton map following the text in the book, you can find the address for a new location."
};

function showhintPoneLOC01_4_5() {
  document.getElementById("hintPoneLOC01_4_5").style.display = "block";
  document.getElementById("hintPoneLOC01_4_5Answer").innerHTML = "The address is C46."
};

function showhintPoneLOC01_5() {
  document.getElementById("hintPoneLOC01_5").style.display = "block";
  document.getElementById("hintPoneLOC01_5Answer").innerHTML = "There is an object from another location that is obviously connected to this puzzle. If you haven't found it yet, return to this later."
};

function showhintPoneLOC01_5_1() {
  document.getElementById("hintPoneLOC01_5_1").style.display = "block";
  document.getElementById("hintPoneLOC01_5_1Answer").innerHTML = "The pumpkin is not ripe. Is there anything in your power to make it ripe somehow?"
};

function showhintPoneLOC01_5_2() {
  document.getElementById("hintPoneLOC01_5_2").style.display = "block";
  document.getElementById("hintPoneLOC01_5_2Answer").innerHTML = "Use your ability on the pumpkin sprout. You can now add the pumpkin to the cookies mix."
};

function showhintPoneLOC01_6() {
  document.getElementById("hintPoneLOC01_6").style.display = "block";
  document.getElementById("hintPoneLOC01_6Answer").innerHTML = "There is information that you should have gotten from two different sources on another location that can help you open the cryptex."
};

function showhintPoneLOC01_6_1() {
  document.getElementById("hintPoneLOC01_6_1").style.display = "block";
  document.getElementById("hintPoneLOC01_6_1Answer").innerHTML = "You should speak to Emma Korn. She will give you a part of information."
};

function showhintPoneLOC01_6_2() {
  document.getElementById("hintPoneLOC01_6_2").style.display = "block";
  document.getElementById("hintPoneLOC01_6_2Answer").innerHTML = "Did you do something with the parrot in Korns' garden?"
};

function showhintPoneLOC01_6_3() {
  document.getElementById("hintPoneLOC01_6_3").style.display = "block";
  document.getElementById("hintPoneLOC01_6_3Answer").innerHTML = "You should ask Emma about Lena Wonder. You should also use your ability on the parrot and then ask the parrot about things connected to this puzzle."
};

function showhintPoneLOC01_6_4() {
  document.getElementById("hintPoneLOC01_6_4").style.display = "block";
  document.getElementById("hintPoneLOC01_6_4Answer").innerHTML = "What does the talkative parrot say if you ask her about Emma or about the cryptex? Where could you use this instruction?"
};

function showhintPoneLOC01_6_5() {
  document.getElementById("hintPoneLOC01_6_5").style.display = "block";
  document.getElementById("hintPoneLOC01_6_5Answer").innerHTML = "Read only the first letters of the message that your mother left Emma for you. The code word for the cryptex is KEPLER."
};

function showhintPoneLOC01_7() {
  document.getElementById("hintPoneLOC01_7").style.display = "block";
  document.getElementById("hintPoneLOC01_7Answer").innerHTML = "There is a character from another location that could know something about the mural."
};

function showhintPoneLOC01_7_1() {
  document.getElementById("hintPoneLOC01_7_1").style.display = "block";
  document.getElementById("hintPoneLOC01_7_1Answer").innerHTML = "The letter describes the path Mary took form leaving her apartment to the mural. Now that you have the location of the mural you should be able to find Mary's address."
};

function showhintPoneLOC01_7_2() {
  document.getElementById("hintPoneLOC01_7_2").style.display = "block";
  document.getElementById("hintPoneLOC01_7_2Answer").innerHTML = "Track Mary's movements backwards, from the mural to her apartment, using the Majorton map."
};

function showhintPoneLOC01_7_3() {
  document.getElementById("hintPoneLOC01_7_3").style.display = "block";
  document.getElementById("hintPoneLOC01_7_3Answer").innerHTML = "The address is A82."
};

function togglePoneLOC02() {
  var hintPoneLOC02_0 = document.getElementById("hintPoneLOC02_0");
  if (hintPoneLOC02_0.style.display == "block") {
    hintPoneLOC02_0.style.display = "none";;
    document.getElementById("locPoneLOC02").value = "Location LOC02";
    document.getElementById("hintPoneLOC02_2").style.display = "none";;
    document.getElementById("hintPoneLOC02_3").style.display = "none";;
    document.getElementById("hintPoneLOC02_4").style.display = "none";;
    document.getElementById("hintPoneLOC02_5").style.display = "none";;
  }
  else {
    hintPoneLOC02_0.style.display = "block";
    document.getElementById("hintPoneLOC02_0Answer").innerHTML = "Have you talked to all of the characters?"
    document.getElementById("locPoneLOC02").value = "Hide hints for LOC02";
  }
};

function showhintPoneLOC02_1() {
  document.getElementById("hintPoneLOC02_1").style.display = "block";
  document.getElementById("hintPoneLOC02_1Answer").innerHTML = "Both characters have something or know something that you need in exchange for something from you. Also, one of them leads you to a new location. If you already figured all of this out and opened the new location, and you're stuck later in the game, look at hints LOC02_4 or LOC02_5."
};

function showhintPoneLOC02_2() {
  document.getElementById("hintPoneLOC02_2").style.display = "block";
  document.getElementById("hintPoneLOC02_2Answer").innerHTML = "What brought you to the shop? Talk to Peter about this. This conversation should also lead you into opening a new location."
};

function showhintPoneLOC02_2_1() {
  document.getElementById("hintPoneLOC02_2_1").style.display = "block";
  document.getElementById("hintPoneLOC02_2_1Answer").innerHTML = "Your telescope is broken. Show it to Peter."
};

function showhintPoneLOC02_2_2() {
  document.getElementById("hintPoneLOC02_2_2").style.display = "block";
  document.getElementById("hintPoneLOC02_2_2Answer").innerHTML = "There was a message with a library logo behind the lens. Find the library on the map, type the library address in the input field and click 'OK' or press Enter."
};

function showhintPoneLOC02_2_3() {
  document.getElementById("hintPoneLOC02_2_3").style.display = "block";
  document.getElementById("hintPoneLOC02_2_3Answer").innerHTML = "The address of the library is B40."
};

function showhintPoneLOC02_3() {
  document.getElementById("hintPoneLOC02_3").style.display = "block";
  document.getElementById("hintPoneLOC02_3Answer").innerHTML = "Loomey is a street artist. Is there something you have that she could have some information about?"
};

function showhintPoneLOC02_3_1() {
  document.getElementById("hintPoneLOC02_3_1").style.display = "block";
  document.getElementById("hintPoneLOC02_3_1Answer").innerHTML = "You have a photo of a street mural. Maybe Loomey is familiar with it."
};

function showhintPoneLOC02_3_2() {
  document.getElementById("hintPoneLOC02_3_2").style.display = "block";
  document.getElementById("hintPoneLOC02_3_2Answer").innerHTML = "You have to explore other locations to find something that will help Loomey. Return here later."
};

function showhintPoneLOC02_4() {
  document.getElementById("hintPoneLOC02_4").style.display = "block";
  document.getElementById("hintPoneLOC02_4Answer").innerHTML = "Now that you've got the lens, you can fix the telescope."
};

function showhintPoneLOC02_4_1() {
  document.getElementById("hintPoneLOC02_4_1").style.display = "block";
  document.getElementById("hintPoneLOC02_4_1Answer").innerHTML = "There is an object from another location which is connected with the night sky."
};

function showhintPoneLOC02_4_2() {
  document.getElementById("hintPoneLOC02_4_2").style.display = "block";
  document.getElementById("hintPoneLOC02_4_2Answer").innerHTML = "What was written in the book you took from the library?"
};

function showhintPoneLOC02_4_3() {
  document.getElementById("hintPoneLOC02_4_3").style.display = "block";
  document.getElementById("hintPoneLOC02_4_3Answer").innerHTML = "If you transfer the Cygnus constellation to the Majorton map following the text in the book, you can find the address for a new location."
};

function showhintPoneLOC02_4_4() {
  document.getElementById("hintPoneLOC02_4_4").style.display = "block";
  document.getElementById("hintPoneLOC02_4_4Answer").innerHTML = "The address is C46."
};

function showhintPoneLOC02_5() {
  document.getElementById("hintPoneLOC02_5").style.display = "block";
  document.getElementById("hintPoneLOC02_5Answer").innerHTML = "There is an object from another location that is clearly connected to the mural."
};

function showhintPoneLOC02_5_1() {
  document.getElementById("hintPoneLOC02_5_1").style.display = "block";
  document.getElementById("hintPoneLOC02_5_1Answer").innerHTML = "The letter describes the path Mary took form leaving her apartment to the mural. Now that you have the location of the mural you should be able to find Mary's address."
};

function showhintPoneLOC02_5_2() {
  document.getElementById("hintPoneLOC02_5_2").style.display = "block";
  document.getElementById("hintPoneLOC02_5_2Answer").innerHTML = "Track Mary's movements backwards, from the mural to her apartment, using the Majorton map."
};

function showhintPoneLOC02_5_3() {
  document.getElementById("hintPoneLOC02_5_3").style.display = "block";
  document.getElementById("hintPoneLOC02_5_3Answer").innerHTML = "The address is A82."
};

function togglePoneLOC03() {
  var hintPoneLOC03_0 = document.getElementById("hintPoneLOC03_0");
  if (hintPoneLOC03_0.style.display == "block") {
    hintPoneLOC03_0.style.display = "none";;
    document.getElementById("locPoneLOC03").value = "Location LOC03";
    document.getElementById("hintPoneLOC03_2").style.display = "none";;
    document.getElementById("hintPoneLOC03_3").style.display = "none";;
  }
  else {
    hintPoneLOC03_0.style.display = "block";
    document.getElementById("hintPoneLOC03_0Answer").innerHTML = "Have you talked to all of the characters?"
    document.getElementById("locPoneLOC03").value = "Hide hints for LOC03";
  }
};

function showhintPoneLOC03_1() {
  document.getElementById("hintPoneLOC03_1").style.display = "block";
  document.getElementById("hintPoneLOC03_1Answer").innerHTML = "One of the characters can give you something you need in exchange for something from you. The other character isn't crucial for the progress of the game, but gives you some information about the story."
};

function showhintPoneLOC03_2() {
  document.getElementById("hintPoneLOC03_2").style.display = "block";
  document.getElementById("hintPoneLOC03_2Answer").innerHTML = "What brought you to the university? Talk to Professor Martin about this."
};

function showhintPoneLOC03_2_1() {
  document.getElementById("hintPoneLOC03_2_1").style.display = "block";
  document.getElementById("hintPoneLOC03_2_1Answer").innerHTML = "Professor Martin is a mineralogy professor and you have a very special gem."
};

function showhintPoneLOC03_3() {
  document.getElementById("hintPoneLOC03_3").style.display = "block";
  document.getElementById("hintPoneLOC03_3Answer").innerHTML = "It's always a good idea to speak about the objects that are in the same location as the character."
};

function showhintPoneLOC03_3_1() {
  document.getElementById("hintPoneLOC03_3_1").style.display = "block";
  document.getElementById("hintPoneLOC03_3_1Answer").innerHTML = "Jamie is in your mineralogy class, so he is probably interested in the mineralogy test tomorrow. Also, did you speak to somebody about the university flag?"
};

function showhintPoneLOC03_3_2() {
  document.getElementById("hintPoneLOC03_3_2").style.display = "block";
  document.getElementById("hintPoneLOC03_3_2Answer").innerHTML = "You need an object from another location to help Jamie."
};

function showhintPoneLOC03_3_3() {
  document.getElementById("hintPoneLOC03_3_3").style.display = "block";
  document.getElementById("hintPoneLOC03_3_3Answer").innerHTML = "It seems that messing with the flag makes everybody on the university stop whatever they are doing and focus only on the flag."
};

function showhintPoneLOC03_3_4() {
  document.getElementById("hintPoneLOC03_3_4").style.display = "block";
  document.getElementById("hintPoneLOC03_3_4Answer").innerHTML = "Spray the flag with spray paint. That way, when the flag goes up the professor will leave the desk to see what's happening and leave the tests unsupervised."
};

function togglePoneLOC04() {
  var hintPoneLOC04_0 = document.getElementById("hintPoneLOC04_0");
  if (hintPoneLOC04_0.style.display == "block") {
    hintPoneLOC04_0.style.display = "none";;
    document.getElementById("locPoneLOC04").value = "Location LOC04";
    document.getElementById("hintPoneLOC04_2").style.display = "none";;
    document.getElementById("hintPoneLOC04_3").style.display = "none";;
    document.getElementById("hintPoneLOC04_4").style.display = "none";;
    document.getElementById("hintPoneLOC04_5").style.display = "none";;
  }
  else {
    hintPoneLOC04_0.style.display = "block";
    document.getElementById("hintPoneLOC04_0Answer").innerHTML = "Have you talked to the character?"
    document.getElementById("locPoneLOC04").value = "Hide hints for LOC04";
  }
};

function showhintPoneLOC04_1() {
  document.getElementById("hintPoneLOC04_1").style.display = "block";
  document.getElementById("hintPoneLOC04_1Answer").innerHTML = "Sandy can give you something important and help you open a new location if you ask her the right questions. If you already figured this out, opened the new location, and you're stuck later in the game, look at hints LOC04_3, LOC04_4 or LOC04_5."
};

function showhintPoneLOC04_2() {
  document.getElementById("hintPoneLOC04_2").style.display = "block";
  document.getElementById("hintPoneLOC04_2Answer").innerHTML = "What brought you to the library? Ask Sandy about this. Also, it's always a good idea to speak about the objects that are in the same location as the character."
};

function showhintPoneLOC04_2_1() {
  document.getElementById("hintPoneLOC04_2_1").style.display = "block";
  document.getElementById("hintPoneLOC04_2_1Answer").innerHTML = "Ask Sandy about the paper you found behind the lens. Also, if you ask Sandy about the lecture poster it can lead you to a new location."
};

function showhintPoneLOC04_2_2() {
  document.getElementById("hintPoneLOC04_2_2").style.display = "block";
  document.getElementById("hintPoneLOC04_2_2Answer").innerHTML = "What does Sandy say about the tea shop? Use this information with the Majorton map and find the address of the tea shop."
};

function showhintPoneLOC04_2_3() {
  document.getElementById("hintPoneLOC04_2_3").style.display = "block";
  document.getElementById("hintPoneLOC04_2_3Answer").innerHTML = "The address is B38."
};

function showhintPoneLOC04_3() {
  document.getElementById("hintPoneLOC04_3").style.display = "block";
  document.getElementById("hintPoneLOC04_3Answer").innerHTML = "Is Peter card still in the game? If it is, you still don't have necessary object to solve this puzzle. Return to this later."
};

function showhintPoneLOC04_3_1() {
  document.getElementById("hintPoneLOC04_3_1").style.display = "block";
  document.getElementById("hintPoneLOC04_3_1Answer").innerHTML = "Now that you've got the lens, you can fix the telescope."
};

function showhintPoneLOC04_3_2() {
  document.getElementById("hintPoneLOC04_3_2").style.display = "block";
  document.getElementById("hintPoneLOC04_3_2Answer").innerHTML = "What was written in the book that Sandy gave you?"
};

function showhintPoneLOC04_3_3() {
  document.getElementById("hintPoneLOC04_3_3").style.display = "block";
  document.getElementById("hintPoneLOC04_3_3Answer").innerHTML = "If you transfer the Cygnus constellation to the Majorton map following the text in the book, you can find the address for a new location."
};

function showhintPoneLOC04_3_4() {
  document.getElementById("hintPoneLOC04_3_4").style.display = "block";
  document.getElementById("hintPoneLOC04_3_4Answer").innerHTML = "The address is C46."
};

function showhintPoneLOC04_4() {
  document.getElementById("hintPoneLOC04_4").style.display = "block";
  document.getElementById("hintPoneLOC04_4Answer").innerHTML = "Do you have something that you can use on the house fly?"
};

function showhintPoneLOC04_4_1() {
  document.getElementById("hintPoneLOC04_4_1").style.display = "block";
  document.getElementById("hintPoneLOC04_4_1Answer").innerHTML = "Use your ability on the house fly."
};

function showhintPoneLOC04_4_2() {
  document.getElementById("hintPoneLOC04_4_2").style.display = "block";
  document.getElementById("hintPoneLOC04_4_2Answer").innerHTML = "You can now use the hypnotised house fly on something in another location."
};

function showhintPoneLOC04_5() {
  document.getElementById("hintPoneLOC04_5").style.display = "block";
  document.getElementById("hintPoneLOC04_5Answer").innerHTML = "Could the projector be useful to you? And are you allowed to use it?"
};

function showhintPoneLOC04_5_1() {
  document.getElementById("hintPoneLOC04_5_1").style.display = "block";
  document.getElementById("hintPoneLOC04_5_1Answer").innerHTML = "To borrow the projector you have to do something about Jocelyn's lecture tonight. Find her on another location."
};

function showhintPoneLOC04_5_2() {
  document.getElementById("hintPoneLOC04_5_2").style.display = "block";
  document.getElementById("hintPoneLOC04_5_2Answer").innerHTML = "There is a character that could use the projector very well, and could give you something in return."
};

function showhintPoneLOC04_5_3() {
  document.getElementById("hintPoneLOC04_5_3").style.display = "block";
  document.getElementById("hintPoneLOC04_5_3Answer").innerHTML = "Give the projector to Loomey."
};

function togglePoneLOC05() {
  var hintPoneLOC05_0 = document.getElementById("hintPoneLOC05_0");
  if (hintPoneLOC05_0.style.display == "block") {
    hintPoneLOC05_0.style.display = "none";;
    document.getElementById("locPoneLOC05").value = "Location LOC05";
    document.getElementById("hintPoneLOC05_2").style.display = "none";;
    document.getElementById("hintPoneLOC05_3").style.display = "none";;
  }
  else {
    hintPoneLOC05_0.style.display = "block";
    document.getElementById("hintPoneLOC05_0Answer").innerHTML = "Have you talked to all of the characters and examined all of the objects with a magnifying glass symbol?"
    document.getElementById("locPoneLOC05").value = "Hide hints for LOC05";
  }
};

function showhintPoneLOC05_1() {
  document.getElementById("hintPoneLOC05_1").style.display = "block";
  document.getElementById("hintPoneLOC05_1Answer").innerHTML = "One of the characters is preventing you from taking an object that you need. The other character can help you in solving this problem."
};

function showhintPoneLOC05_2() {
  document.getElementById("hintPoneLOC05_2").style.display = "block";
  document.getElementById("hintPoneLOC05_2Answer").innerHTML = "In this case, it's more important to figure out what do you need from her than what to talk about with her."
};

function showhintPoneLOC05_2_1() {
  document.getElementById("hintPoneLOC05_2_1").style.display = "block";
  document.getElementById("hintPoneLOC05_2_1Answer").innerHTML = "If you want to borrow the projector from the library, you have to make sure that the lecture is canceled."
};

function showhintPoneLOC05_2_2() {
  document.getElementById("hintPoneLOC05_2_2").style.display = "block";
  document.getElementById("hintPoneLOC05_2_2Answer").innerHTML = "She has the lecture on her password protected computer. If you could get to the computer, you could delete the lecture."
};

function showhintPoneLOC05_2_3() {
  document.getElementById("hintPoneLOC05_2_3").style.display = "block";
  document.getElementById("hintPoneLOC05_2_3Answer").innerHTML = "Did you talk to Mark? He had a good look on Jocelyn during the afternoon."
};

function showhintPoneLOC05_2_3_1() {
  document.getElementById("hintPoneLOC05_2_3_1").style.display = "block";
  document.getElementById("hintPoneLOC05_2_3_1Answer").innerHTML = "Jocelyn keeps opening her computer and typing in her password. Is there a way that you could somehow see the password while she's typing it?"
};

function showhintPoneLOC05_2_3_2() {
  document.getElementById("hintPoneLOC05_2_3_2").style.display = "block";
  document.getElementById("hintPoneLOC05_2_3_2Answer").innerHTML = "What about the house fly in the library? Could she be of any help in this situation?"
};

function showhintPoneLOC05_2_3_3() {
  document.getElementById("hintPoneLOC05_2_3_3").style.display = "block";
  document.getElementById("hintPoneLOC05_2_3_3Answer").innerHTML = "Hypnotise the house fly by using your ability. Make the fly look at Jocelyn's computer so that it sees which keys Jocelyn is pressing while typing in her password."
};

function showhintPoneLOC05_2_4() {
  document.getElementById("hintPoneLOC05_2_4").style.display = "block";
  document.getElementById("hintPoneLOC05_2_4Answer").innerHTML = "What can you find on Jocelyn's table that you can use so that she would leave the table?"
};

function showhintPoneLOC05_2_4_1() {
  document.getElementById("hintPoneLOC05_2_4_1").style.display = "block";
  document.getElementById("hintPoneLOC05_2_4_1Answer").innerHTML = "If a person drinks a lot of tea, they are bound to go to the toilet sooner or later."
};

function showhintPoneLOC05_2_4_2() {
  document.getElementById("hintPoneLOC05_2_4_2").style.display = "block";
  document.getElementById("hintPoneLOC05_2_4_2Answer").innerHTML = "Order some tea from Mark by giving him Jocelyn's empty cup. Offer the cup of tea to Jocelyn."
};

function showhintPoneLOC05_3() {
  document.getElementById("hintPoneLOC05_3").style.display = "block";
  document.getElementById("hintPoneLOC05_3Answer").innerHTML = "It's always a good idea to talk about other characters in the same location."
};

function togglePoneLOC06() {
  var hintPoneLOC06_0 = document.getElementById("hintPoneLOC06_0");
  if (hintPoneLOC06_0.style.display == "block") {
    hintPoneLOC06_0.style.display = "none";;
    document.getElementById("locPoneLOC06").value = "Location LOC06";
    document.getElementById("hintPoneLOC06_2").style.display = "none";;
    document.getElementById("hintPoneLOC06_3").style.display = "none";;
    document.getElementById("hintPoneLOC06_4").style.display = "none";;
  }
  else {
    hintPoneLOC06_0.style.display = "block";
    document.getElementById("hintPoneLOC06_0Answer").innerHTML = "Have you talked to the character?"
    document.getElementById("locPoneLOC06").value = "Hide hints for LOC06";
  }
};

function showhintPoneLOC06_1() {
  document.getElementById("hintPoneLOC06_1").style.display = "block";
  document.getElementById("hintPoneLOC06_1Answer").innerHTML = "Emma must know something if your mother left you clues to find her. And objects in her garden can be very useful to."
};

function showhintPoneLOC06_2() {
  document.getElementById("hintPoneLOC06_2").style.display = "block";
  document.getElementById("hintPoneLOC06_2Answer").innerHTML = "Who is the one person that connects you with Emma?"
};

function showhintPoneLOC06_2_1() {
  document.getElementById("hintPoneLOC06_2_1").style.display = "block";
  document.getElementById("hintPoneLOC06_2_1Answer").innerHTML = "There is an object connected to what Emma is saying. You might not have it yet."
};

function showhintPoneLOC06_2_2() {
  document.getElementById("hintPoneLOC06_2_2").style.display = "block";
  document.getElementById("hintPoneLOC06_2_2Answer").innerHTML = "If Laika card is gone, you have all the objects needed to solve the puzzle."
};

function showhintPoneLOC06_2_3() {
  document.getElementById("hintPoneLOC06_2_3").style.display = "block";
  document.getElementById("hintPoneLOC06_2_3Answer").innerHTML = "Can you somehow connect Emma's message to the cryptex? Also, did you do something with the parrot in the garden?"
};

function showhintPoneLOC06_2_4() {
  document.getElementById("hintPoneLOC06_2_4").style.display = "block";
  document.getElementById("hintPoneLOC06_2_4Answer").innerHTML = "You should use your ability on the parrot and then ask the parrot about things connected to this puzzle."
};

function showhintPoneLOC06_2_5() {
  document.getElementById("hintPoneLOC06_2_5").style.display = "block";
  document.getElementById("hintPoneLOC06_2_5Answer").innerHTML = "What does the talkative parrot say if you ask her about Emma or about the cryptex? Where could you use this instruction?"
};

function showhintPoneLOC06_2_6() {
  document.getElementById("hintPoneLOC06_2_6").style.display = "block";
  document.getElementById("hintPoneLOC06_2_6Answer").innerHTML = "Read only the first letters of the message that your mother left Emma for you. The code word for the cryptex is KEPLER."
};

function showhintPoneLOC06_3() {
  document.getElementById("hintPoneLOC06_3").style.display = "block";
  document.getElementById("hintPoneLOC06_3Answer").innerHTML = "Is there something in your power that you can use on the parrot?"
};

function showhintPoneLOC06_3_1() {
  document.getElementById("hintPoneLOC06_3_1").style.display = "block";
  document.getElementById("hintPoneLOC06_3_1Answer").innerHTML = "You should use your ability on the parrot."
};

function showhintPoneLOC06_3_2() {
  document.getElementById("hintPoneLOC06_3_2").style.display = "block";
  document.getElementById("hintPoneLOC06_3_2Answer").innerHTML = "There is an object connected to what the parrot is saying. You might not have it yet."
};

function showhintPoneLOC06_3_3() {
  document.getElementById("hintPoneLOC06_3_3").style.display = "block";
  document.getElementById("hintPoneLOC06_3_3Answer").innerHTML = "If Laika card is gone, you have all the objects needed to solve the puzzle."
};

function showhintPoneLOC06_3_4() {
  document.getElementById("hintPoneLOC06_3_4").style.display = "block";
  document.getElementById("hintPoneLOC06_3_4Answer").innerHTML = "Did you speak to Emma? And did you ask the parrot about things connected to this puzzle?"
};

function showhintPoneLOC06_3_5() {
  document.getElementById("hintPoneLOC06_3_5").style.display = "block";
  document.getElementById("hintPoneLOC06_3_5Answer").innerHTML = "What does the talkative parrot say if you ask her about Emma or about the cryptex? Where could you use this instruction?"
};

function showhintPoneLOC06_3_6() {
  document.getElementById("hintPoneLOC06_3_6").style.display = "block";
  document.getElementById("hintPoneLOC06_3_6Answer").innerHTML = "Read only the first letters of the message that your mother left Emma for you. The code word for the cryptex is KEPLER."
};

function showhintPoneLOC06_4() {
  document.getElementById("hintPoneLOC06_4").style.display = "block";
  document.getElementById("hintPoneLOC06_4Answer").innerHTML = "Is there something that you could use with pumpkin?"
};

function showhintPoneLOC06_4_1() {
  document.getElementById("hintPoneLOC06_4_1").style.display = "block";
  document.getElementById("hintPoneLOC06_4_1Answer").innerHTML = "The pumpkin is not ripe. Is there anything in your power to make it ripe somehow?"
};

function showhintPoneLOC06_4_2() {
  document.getElementById("hintPoneLOC06_4_2").style.display = "block";
  document.getElementById("hintPoneLOC06_4_2Answer").innerHTML = "Use your ability on the pumpkin sprout. You can now add the pumpkin to the cookies mix."
};
