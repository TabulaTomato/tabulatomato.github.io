...
function myFunction() {
	var x = document.getElementById("myText").value;
  	var answer;
  	if (x == "1") {
  		answer = "I’m Ziggy Wonder, a student in the Majorton University. My mother died a few days ago and it’s the hardest thing that ever happened to me.";
  } else if (x == "2") {
  		...
  		answer = "Emma Korn is my mother's friend. They were both members of an environmentalist group called Earthlings.";
	} else if (x == "11" || x == "38") {
  		...
  		answer = "A rare astronomy book. There is also a message inside written in my mother's handwriting. It says:<br><b>α = a corner of Kids Park.<br>ζ = a corner of the Main Square.<br>Go to ι.";
	} else if (x == "18") {
  		...
  		answer = "The password of Jocelyn's computer nicely discovered to me by a simple housefly.";
	} else if (x == "41") {
  		...
  		answer = "My mother’s house looks as if somebody still lives here. My mother’s telescope <b>(25)</b> is placed by the window, pointing at the sky. Our dog, Laika <b>(3)</b> is here, not as cheerful as usual. I can see mix for Laika's favourite cookies <b>(5)</b> on the kitchen counter. There is also a framed photo <b>(21)</b> on the bar that I've never seen before.";
	} else if (x == "B" || x == "b") {
  		...
  		answer = "Another World Library is calm, with only a few people browsing the books. There is a poster about a lecture <b>(7)</b> on the library wall. A projector <b>(20)</b> that is used in library events is mounted on the ceiling. The librarian <b>(9)</b> my mother used to work with is not very occupied at the moment.";
	} else if (x == "E" || x == "e") {
  		...
  		answer = "Korn family farm is small, but cozy. The garden is beautiful and well kept, with plenty of herbs and vegetables. A senna plant <b>(13)</b> catches my eye, as well as pumpkin sprouts <b>(36)</b>. Mrs Korn <b>10</b> is standing by the house doors.";
	} else if (x == "G" || x == "g") {
  		...
  		answer = "Voila, I have the password for Jocelyn's computer now.";
	} else if (x == "1,41") {
  		...
  		answer = "I’ve worked here for 15 years. And I must say that things started to be more interesting when your mother joined us. She organized all kinds of events, concerts, poetry readings, workshops...I’ll try to keep the same spirit in the library now that she’ gone. She would have liked it that way.";
	} else if (x == "9,10") {
  		answer = "I’m sorry but I’ve never met this woman.";
	} else if (x == "9,11" || x == "9,38") {
  		...
  		answer = "I miss Lena so much! She did everything with so much passion. That is until her illness slowed her down. I still can't believe how fast all of this happened! She had her whole life ahead of her. She became friends with professor Martin from the university not long before she got sick, did you know that? I even thought that she finally found a man that's worth her attention. <br><i>Sandy bursts into tears and I stop asking her questions about my mother. Otherwise I will start crying too.</i>";
	} else if (x == "9,24") {
  		...
  		answer = "Jocelyn gave you her computer password? I was under the immpresion that she had golden information on it judging by the way she was holding it.";
	} else if (x == "9,41") {
			...
			answer = "What a pleasure to finally meet you, Ziggy. Lena told me so much about you. She was very proud of you!";
	} else if (x == "10,2" || x == "10,27") {
			answer = "Look, a fly is completely harmless. They are boring, sure, but they are also a useful part of the ecosystem.";
	} else if (x == "10,3") {
			answer = "Lena used to bring Laika with her sometimes. She’s a great dog. She would play with our dogs here on the farm. We have three of them!";
	} else if (x == "10,4") {
			answer = "It’s a good projector. We don’t watch a lot of films here, we usualy play board games.";
	} else if (x == "10,5") {
				answer = "We use the same mix for cookies for our dog, but only during the pumpkin season.";
	} else if (x == "10,6") {
			...
			answer = "Thanks, I can give a few to my dogs. But I'll leave some for Laika.";
	} else if (x == "10,16") {
			answer = "Wow, how beautiful. I would like to know more about stars.";
	} else if (x == "10,17") {
			answer = "This literature is way to hard for me to understand. I know that Lena was an astronomy fan, however.";
	} else if (x == "10,18") {
			answer = "I've never met proffesor Martin, but I know that Lena was seeing him before she got sick. I was happy for her! She was speaking of him with great enthusiasm. I think she didn't tell you about it because she didn't want to put you in a weird position, with him being your professor. Anyway, she got sick before it turned into something more serious. How tragic, all of it.";
	} else if (x == "10,19") {
			...
			answer = "Lena was my dear friend. We grew close a few years ago, as she joined our environmentalist group the Earthlings. We did research on the big polluters in the country, wrote propositions of stricter laws for protecting the environment, promoted zero waste living, that sort of thing. About 3 months ago, some time before she got sick, she started to do research on something she didn't want to speak about. Some time after, she found out about her illness. Lena's cancer spread very fast and she couldn't work anymore. She started to lose her memory as well, very rapidly. It was devastating to see her like this! While she was still in her right mind, she gave me a memory stick for safekeeping. It was full of some ciphered information that made no sense to me. She actually said that if something happened to her I should give it to you. But unfortunately, our house was robbed 10 days ago. They took everything, my computer, my hard drives, my cameras, and the memory stick as well. I'm so sorry Ziggy, I should have hidden it better.";
	} else if (x == "10,24") {
			...
			answer = "You're breaking into other people's computers? Why Ziggy, why?";
	} else if (x == "10,41") {
	...
	} else if (x == "11,1" || x == "38,1") {
			answer = "Hello, nice to meet you. Your mother used to work at the library? I’m so sorry for your loss.";
	} else if (x == "11,2" || x == "38,27") {
			answer = "Get that away from me!";
	} else if (x == "11,3" || x == "38,3") {
			answer = "What a cute dog!";
	} else if (x == "11,5" || x == "38,5") {
			answer = "I don't know what I'm supposed to do with this.";
	} else if (x == "11,6") {
			answer = "<i>I should get the computer password before I send Jocelyn to the toilet.</i>";
	} else if (x == "38,6") {
			answer = "Thank you, that’s really nice of you. Sluuuurp! <br><i>Jocelyn drinks her tea and a few minutes after she excuses her and runs to the toilet. <br>Take card <b>22</b>. Remove cards <b>6</b> and <b>43</b>.</i>";
	} else if (x == "11,7" || x == "38,7") {
			...
			answer = "<i>I'm not going to tell Jocelyn that I have the password to her computer.</i>";
	} else if (x == "11,42" || x == "38,42") {
			answer = "I’ve seen a mural that she did in Munich. She is pretty good, isn’t she?";
	} else if (x == "11,43" || x == "38,43") {
			answer = "I have my lecture on it. So at the moment, it’s my most precious possession.";
	} else if (x == "14,1" || x == "14,14" || x == "14,23") {
			answer = "I can’t believe I’m speaking to you, Ziggy. The last time I saw you, you were a small child, and now you’re all grown up. How did you even find me, Lena and I aren't in contact for years...What? She died? I never got a chance to say goodbye...<br><i>Mary’s voice breaks, as she struggles not to burst into tears.</i> <br>I’m sorry, it’s just very hard to hear this. I can’t even imagine how you must feel. So how did she die? Cancer? But...That's impossible. Our kind doesn't get sick, not that way at least. Yes, Ziggy, you heard me right. Our kind. You should probably sit down to hear this.<br><i>Mary shows you to the couch and offers you some biscuits and coffee.</i><br>So, you probably realised that your mother had some secrets. And she didn't want you to know any of them, but I think that she changed her mind if she left you these clues to find me. I guess she couldn't tell you directly. Was she being watched at? I don't know. But if somebody hurt her, it's possible that all of us are in danger.<br><i>Mary takes a sip of her coffee and looks me straight into the eyes.</i><br>I see that she gave you the gem. You must have noticed that it gives you some...powers. And these powers will grow, Ziggy. That's because the gem connects you with your true nature. And your nature...our nature is not from this world. Ziggy, we are not human.<br><i>I actually start to freak out a bit and wonder if this Mary person is in her right mind. But why would my mother send me to her if she isn't? Meanwhile, Mary continues with her story.</i><br>We come from a planet that humans call Kepler-22b, orbiting a star in Cygnus constellation. We call it Nahukat.<br><i>'Nahukat' is just the closest that I can do to repeat what Mary just pronounced. It really does sound like a completely different language...Or more like another way to produce sound.</i><br>Our species was forced to leave our planet about 300 years ago, saving the small number of us that survived from extinction - exactly 24.398 to be precise. Our planet was colonised by a parasite civilisation, one we call the Lakis. They established their power over Nahukat and then slightly drained its' resources.<br><i>Mary stops for a second to put herself together. It's obviously not easy for her to talk about all of this.</i><br>Your mother and I were born and raised on the ship, educated to be astronauts and trained for missions in search of a habitable planet. Two of us left the mothership 28 years ago in a crew of five. Needless to say that the five of us became best friends. Not only that, but Lena fell in love with one of our crew members: your father.<br><i>My father! I always knew that the story about a sperm donor was suspicious.</i><br>Our mission was actually incredibly successful! In just a few years we came across Voyager, one of Earth's spacecrafts, where we found this Golden Record. It was describing a planet with everything we were looking for, and even had something like a map so we could locate this planet. We were absolutely ecstatic about the discovery! But when we tried to communicate with the mothership, we found out that our communication system was corrupted. While we were berthing to Voyager, a part of the spacecraft hit our ship and disabled our antenna. One of us had to go out and fix it. You're guessing right, it was Peku, your father.<br><i>Mary's eyes fill with tears again.</i><br> When he got out, he saw that the antenna is completely destroyed, and not only this - one of our modules suffered a lot of damage. He had to react fast, otherwise we would all die. He entered into the module to undock it form the rest of the ship. That's when something went terribly wrong. One of the oxygen tanks in the module was hit during the accident and as Peku disconnected the module it exploded. So Peku sacrificed his life to save us. To save you, too.<br><i>Mary stops for a moment and I see the pain in her eyes.</i><br> We didn't have a way to contact our mothership. All we had were instructions how to get to Earth and hope of fixing our communication system once we get there. And so we did. The four of us with you in your mother's belly landed on Earth 20 years ago. You were born here, a few months later. And despite all of our efforts, we still didn't manage to construct an antenna strong enough to contact our nation. The technology here is just not yet developed enough.<br><i>Mary takes a deep breath.</i><br> The first two years of our life on Earth, Lena was focused on our goal as much as the rest of us, while trying to create a normal life for both of you in the same time. But she was taking extreme care not to speak about our origin or our task when you were around. She wanted you to have a happy, human childhood, keeping the truth a secret. I didn't agree with this. I thought that you have to know who you are. And as you grew, we fought about it more and more. Finally, when you were three years old, and with our research in fixing our communication system having no progress whatsoever, she decided to cut off our friendship completely. She was afraid that I will tell you something. I tried to contact her a few times during the years by sending her letters. I never got a response. Until now, that is.<br><i>Mary takes my hand.</i><br> Ziggy, it's time to start living your true life. I will introduce you to the rest of the crew and teach you everything you have to know about us. And as I already said, your mother couldn't have died of cancer. Our people can't develop that kind of sickness. We have to find out what happened to her. She sent you to me with a reason, there is surely something dangerous going on. But don't be scared, you're not alone in this!<br><i>Chapter One of the game is now finished. To unravel the mystery of Lena's death and continue Ziggy's adventure, start Chapter Two. Thank you for playing!</i>";
	} else if (x == "14,8") {
			...
			answer = "Lena was seeing someone? A professor from the university? I'm glad that she was able to finally move forward after the loss of your father. She told you that your father was just a sperm donor? Well Ziggy, that's not the truth.";
	} else if (x == "14,28") {
	...
	} else if (x == "18,10" || x == "18,11" || x == "18,14" || x == "30,38") {
			...
			answer = "You’re not thinking of bribing me I hope? Ziggy, I'm sure you can pass the test without this. Take as much time as you need, all of us on the university understand that you need some time to get back on your feet.";
	} else if (x == "18,20") {
			...
			answer = "Of course I remember your mother, I was very often in the library. In fact, we became friends not long before...well, before she discovered she was ill. We had great conversations, she was a very intelligent and educated woman. We used to grab a cup of tea together during her break in the tea shop next door to her library. It must be a bit strange for you to hear that your professor was socialising with your mother, but I assure you that we were just friends. Anyway, I was extremly sad when I heard the news. And I'm so sorry that I couldn't make it to the funeral, I wasn't in the country at the time. If there's anything that I could do for you Ziggy, I'd be happy to.";
	} else if (x == "18,28") {
			...
			answer = "That's a great cup, but we are not allowed to receive gifts from students.";
	} else if (x == "18,35") {
	...
	} else if (x == "30,9" || x == "30,10" || x == "30,11" || x == "30,38") {
			...
			answer = "You got the chick's computer password, did you? I was sure that you're quite capable when you put your mind into something.";
	} else if (x == "31,42") {
			answer = "I don’t know her, but she is dank!";
	} else if (x == "32,1") {
			answer = "Hi, what can I get you?";
	} else if (x == "32,2" || x == "32,27") {
			answer = "Nice fly!";
	} else if (x == "32,3") {
			answer = "Nice dog!";
	} else if (x == "32,4") {
	...
	} else if (x == "32,6" || x == "32,26") {
			answer = "No thanks, I can’t even look at tea anymore.";
	} else if (x == "32,7") {
			answer = "Sure, I’ve seen the poster in the library. That’s Jocelyn Hill right there. She’s freaking out about the lecture a bit.";
	} else if (x == "32,8") {
			...
			answer = "I saw the guy quite a few times here with your mother. They often came for a cup of tea during her break. It started maybe two or three months ago, some time before...well, you know. Before she got sick. She was happy with him, that much I can tell you. They would passionately discuss science, astronomy, geology, that kind of stuff. And the guy seemed very much into Lena too. He wouldn't take his eyes of her. I haven't see him since Lena stopped working at the library around a month ago.";
	} else if (x == "32,19") {
			...
			answer = "Lena was your mother? Oh, I’m really sorry. Lena was my favourite customer. She came here every day during her break for a cup of mint tea, super sweet. She hasn’t been coming for the last month, of course. It's really sad. Especially after seeing her so happy just before she got sick, hanging around with this professor and falling in love.";
	} else if (x == "32,24") {
			...
			answer = "You got the password to Jocelyn's computer? Listen, since you're Lena's daughter and you seem nice, I'm going to pretend that I didn't see anything. But I really hope that you have a good reason for whatever you're doing.";
	} else if (x == "32,41") {
			...
			answer = "A projector would actually save me! I could preject the sketch on the wall and transfer it really quickly. Is there a possibility that you could get it for me?";
	} else if (x == "42,21") {
			...
			answer = "Well done on finding someone's computer password. That's really NOT cool of you.";
	} else if (x == "42,42") {
	...
	} else if (x == "2,3" || x == "3,2" || x == "3,27" || x == "27,3") {
      answer = "Laika doesn't mind the fly. She's a peaceful animal.";
	} else if (x == "2,6" || x == "2,26" || x == "2,34" || x == "6,2" || x == "26,2" || x == "34,2" || x == "6,27" || x == "26,27" || x == "34,27" || x == "272" || x == "27,26" || x == "27,34") {
	...
	} else if (x == "3,3" || x == "3,23") {
			answer = "Woof woof!";
	} else if (x == "3,5" || x == "5,3") {
			answer = "I can't make the cookies without the pumpkin. It's the best part!";
	} else if (x == "3,8" || x == "8,3") {
			answer = "As I focus on Laika, I start feel that I have some kind of power over her. I can make her do all the tricks perfectly, despite the fact that she is the worst trained dog on this planet. She even manages to bark in a pretty melody. But at the same time I sense that she’s really sad and that she would love to eat some of her favourite cookies that would remind her of my mother. I also feel that she wants to show me something, but she’s way to depressed to do it. And even with my superpowers, I can't change her mind.";
	} else if (x == "3,5" || x == "3,41" || x == "5,3" || x == "41,3") {
			answer = "Cookies are not finished yet!";
	} else if (x == "3,15" || x == "15,3") {
			answer = "There you go, Laika! <br><i>Laika barks and eats the cookies with pleasure. She seems to feel much better. After she finishes, she barks to get my attention. I realise that she wants to show me something, so I follow her. She goes upstairs and starts digging in my mother's closet. I'm just about to calm her down, so that she doesn't make a huge mess, when she comes out with a letter in her mouth. I somehow understand that Laika’s telling me how important this letter was to my mother. After I take the letter, Laika barks and runs downstairs and out in the backyard.<br><i>Take card <b>14</b>. Remove cards <b>3</b>, b>15</b> and location card<b>A</b>.</i>";
	} else if (x == "3,26" || x == "26,3") {
			answer = "The tea is not for Laika.";
	} else if (x == "3,6" || x == "3,13" || x == "6,3" || x == "13,3") {
			answer = "Laika’s digestion works just fine.";
	} else if (x == "4,21" || x == "21,4") {
			answer = "Where and why should I make a projection of this photo?";
  } else if (x == "5,36" || x == "36,5") {
  ...
  } else if (x == "5,41" || x == "41,5") {
      answer = "Finally, let's put this pumpkin in the mix. 30 minutes in the oven and here come the best dog cookies Laika could wish for.<br><i>Take card <b>15</b>. Remove cards <b>5</b> and <b>41</b>.</i>";
	} else if (x == "7,35" || x == "35,7") {
			answer = "It wouldn’t do any good if I paint over the lecture poster. The lecture would have still been held.";
	} else if (x == "8,9" || x == "8,10" || x == "8,11" || x == "8,14" || x == "8,18" || x == "8,30" || x == "8,31" || x == "8,32") {
	...
	} else if (x == "13,26" || x == "26,13") {
			answer = "This is really wicked of me, and I’m definitely not proud of myself for doing it, but I don’t see that I have any other choice. <br><i>Take card <b>6</b>. Remove cards <b>13</b> and <b>26</b>.</i>";
	} else if (x == "13,34" || x == "34,13") {
	...
	} else if (x == "2 Story St" || x == "2 story st") {
			answer = "Maybe there is something in the library worth looking at.<br><i>Take location card <b>D</b>.</i>";
	} else if (x == "3 Story St" || x == "3 story st") {
			answer = "So let's meet this Jocelyn Hill.<br><i>Take location card <b>E</b>.</i>";
	} else if (x == "1 Story St" || x == "1 story st") {
			answer = "There is no tea shop on this address. So i guess it's the on other next door to the library.";
	} else if (x == "1 Lucky St" || x == "1 lucky st") {
			answer = "I hope I got the address right from this puzzle my mother left me.<br><i>Take location card <b>F</b>.</i>";
	} else if (x == "3 Apple St" || x == "3 apple st") {
